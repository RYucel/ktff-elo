...
assets/     kulüp logoları (src/ktff_logo.py toplar)
...
Logolar KTFF maç sayfalarından bir kez toplanır ve depoya işlenir; site onları
kendi sunucusundan verir (`/logo/*.webp`, 7 gün önbellek), KTFF'ye sıcak bağlantı
yapılmaz.
...
Eşleme `data/logolar.json`, görseller `assets/logo/` altındadır. 54 kulübün
tamamının logosu mevcut. Haftalık otomasyonun parçası değildir — yalnız yeni bir
kulüp lige katıldığında çalıştırmak gerekir.
